...
//--------------------------------------------------------------------------------
private static void testGetParametersFromRequest()
throws Exception
{

{
MHttpRequest request = new MHttpRequest( "GET /?a=b&c=d&e=%42&%41=abc HTTP/1.0\r\n\r\n" );
List list = getParametersFromRequest( request );
if( list.size() != 4 ) { throw new Exception(); }
if( !( ( MParameter )( list.get( 0 ) ) ).getName().equals( "a" ) ) { throw new Exception(); }
if( !( ( MParameter )( list.get( 1 ) ) ).getName().equals( "c" ) ) { throw new Exception(); }
if( !( ( MParameter )( list.get( 2 ) ) ).getName().equals( "e" ) ) { throw new Exception(); }
if( !( ( MParameter )( list.get( 0 ) ) ).getValue().equals( "b" ) ) { throw new Exception(); }
if( !( ( MParameter )( list.get( 1 ) ) ).getValue().equals( "d" ) ) { throw new Exception(); }
if( !( ( MParameter )( list.get( 2 ) ) ).getValue().equals( "B" ) ) { throw new Exception(); }
if( !( ( MParameter )( list.get( 3 ) ) ).getName().equals( "A" ) ) { throw new Exception(); }
if( !( ( MParameter )( list.get( 3 ) ) ).getValue().equals( "abc" ) ) { throw new Exception(); }
}

{
MHttpRequest request = new MHttpRequest( "POST / HTTP/1.0\r\nContent-Type: application/x-www-form-urlencoded\r\nContent-Length: 0\r\n\r\n" );
request.setBody( "a=b&c=d&e=%42" );
...
if( !( ( MParameter )( list.get( 0 ) ) ).getValue().equals( "b" ) ) { throw new Exception(); }
if( !( ( MParameter )( list.get( 1 ) ) ).getValue().equals( "d" ) ) { throw new Exception(); }
if( !( ( MParameter )( list.get( 2 ) ) ).getValue().equals( "%42" ) ) { throw new Exception(); } //not decoded
}

}
//--------------------------------------------------------------------------------
public static List toIpList( String hostNameString )
throws UnknownHostException
{
/* hostNameString‚Í "www.example.jp" "1.2.3.4" "www.example.jp,www2.example.jp" "1.2.3.4,1.2.3.3" "www.example.jp,1.2.3.4"‚Ý‚½‚¢‚ÈƒP[ƒX‚ª‚ ‚è‚¦‚é
 * 
 */

List list = new ArrayList();
String[] hostArray = hostNameString.split( ",\\s*" );
for( int i = 0; i < hostArray.length; ++i )
	{
	InetAddress[] addrArray = InetAddress.getAllByName( hostArray[ i ] );
...
//--------------------------------------------------------------------------------
public static void testToIpList()
throws Exception
{
if( ! new HashSet( toIpList( "localhost" ) ).equals( new HashSet( Arrays.asList( new Object[]{ "127.0.0.1" } ) ) ) ) { throw new Exception(); }
if( ! new HashSet( toIpList( "127.0.0.1" ) ).equals( new HashSet( Arrays.asList( new Object[]{ "127.0.0.1" } ) ) ) ) { throw new Exception(); }
if( ! new HashSet( toIpList( "127.0.0.1,1.2.3.4" ) ).equals( new HashSet( Arrays.asList( new Object[]{ "127.0.0.1", "1.2.3.4" } ) ) ) ) { throw new Exception(); }
if( ! new HashSet( toIpList( "secure10.scutum.jp" ) ).equals( new HashSet( Arrays.asList( new Object[]{ "118.151.187.101", "118.151.189.101" } ) ) ) ) { throw new Exception(); }
if( ! new HashSet( toIpList( "localhost, secure10.scutum.jp" ) ).equals( new HashSet( Arrays.asList( new Object[]{ "127.0.0.1", "118.151.187.101", "118.151.189.101" } ) ) ) ) { throw new Exception(); }
if( ! new HashSet( toIpList( "127.0.0.1, secure10.scutum.jp" ) ).equals( new HashSet( Arrays.asList( new Object[]{ "127.0.0.1", "118.151.187.101", "118.151.189.101" } ) ) ) ) { throw new Exception(); }
if( ! new HashSet( toIpList( "localhost,secure10.scutum.jp" ) ).equals( new HashSet( Arrays.asList( new Object[]{ "127.0.0.1", "118.151.187.101", "118.151.189.101" } ) ) ) ) { throw new Exception(); }
if( ! new HashSet( toIpList( "127.0.0.1,secure10.scutum.jp" ) ).equals( new HashSet( Arrays.asList( new Object[]{ "127.0.0.1", "118.151.187.101", "118.151.189.101" } ) ) ) ) { throw new Exception(); }
}
//--------------------------------------------------------------------------------
